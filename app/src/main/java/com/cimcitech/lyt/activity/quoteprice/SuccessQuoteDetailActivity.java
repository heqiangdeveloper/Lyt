...
public class SuccessQuoteDetailActivity extends AppCompatActivity {
    ...
    public void initTitle(){
        ...
        quote_price_time_label_Tv.setText(getResources().getString(R.string.success_quote_price_label));
    }
