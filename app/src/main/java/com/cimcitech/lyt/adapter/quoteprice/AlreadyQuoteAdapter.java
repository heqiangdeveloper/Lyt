...
public class AlreadyQuoteAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_ITEM = 0;
    private static final int TYPE_FOOTER = 1;
    private List<AlreadyQuoteListBean> data;
    private LayoutInflater inflater;
    private static final int TYPE_END = 2;
    private boolean isNotMoreData = false;

    public AlreadyQuoteAdapter(Context context, List<AlreadyQuoteListBean> data) {
    ...
    private AlreadyQuoteAdapter.OnItemClickListener onItemClickListener;

    public void setOnItemClickListener(AlreadyQuoteAdapter.OnItemClickListener onItemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            ...
            return new AlreadyQuoteAdapter.ItemViewHolder(view);
        } else if (viewType == TYPE_FOOTER) {
            View view = inflater.inflate(R.layout.recycler_foot_view, parent, false);
            return new AlreadyQuoteAdapter.FootViewHolder(view);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof AlreadyQuoteAdapter.ItemViewHolder) {
            ...
            final AlreadyQuoteListBean item = data.get(position);
     ...
     * @param list
     */
    public void updateList(List<AlreadyQuoteListBean> list){
        this.data = list;
